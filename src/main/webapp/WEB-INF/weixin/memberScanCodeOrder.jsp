...
<div class="main">
    <ul class="out-div top">
        <li>
            ...
            <p class="member-single">【乐加会员】
               <c:if test="${scanCodeOrder.leJiaUser.bindMerchant.id==scanCodeOrder.merchant.id}">
                <span>本店锁定</span>
               </c:if>
            </p>
        ...
        <li class="list">
            ...
            <div class="right">
                ...
                <p>(微信¥${scanCodeOrder.truePay/100}，红包¥${scanCodeOrder.trueScore/100})</p>
            </div>
        </li>
        <li class="list">
        ...
        <li class="list">
            ...
            <div class="right">
                ...
                <p>(微信¥${scanCodeOrder.transferMoneyFromTruePay/100}，红包¥${scanCodeOrder.transferMoneyFromScore/100})</p>
            </div>
        </li>
    </ul>
    <ul class="out-div bottom">
        <li>
            ...
            <span class="right">${scanCodeOrder.orderSid}</span>
        </li>
        <li>
